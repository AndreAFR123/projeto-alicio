...
public class ContaDAO {
	...
	public Long inserir(Conta conta) throws SQLException, ClassNotFoundException {
		Long id = null;
		String sqlQuery = "INSERT INTO conta (tp_conta, num_conta) VALUES (?, ?) ";
	...
	public int alterar(Conta conta) throws SQLException, ClassNotFoundException {
		String sqlQuery = "UPDATE conta SET num_conta = ?, nm_conta = ? WHERE idconta = ?";
		...
		try {
			...
			stmt.setLong(3, conta.getIdConta());
